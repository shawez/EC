...
LC_MetadaData <- fread(file = "/home/projects/cu_10158/people/shakha/Functional_Heterogeneity/Public_Data/10X/Lambrechts_2018_E-MTAB-6149/mappedData/LC/LC_metadata.csv.gz", data.table = FALSE)
